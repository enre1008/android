...
import com.example.sunny.baiduspeechdemo.asrfinishjson.AsrFinishJsonData;
import com.example.sunny.baiduspeechdemo.asrpartialjson.AsrPartialJsonData;
...
public class MainActivity extends AppCompatActivity implements EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asr.registerListener(this); //EventListener中 onEvent方法
    ...
    private void initView() {
        ...
        //String libraryDir = getApplicationInfo().nativeLibraryDir;//我自己添加的
        //tvParseResult.setText(libraryDir); //我自己添加的
    }
    ...
    @Override
    public void onRequestPermissionsResult(int requestCode, String[] persmissions,
                                           int[] grantRsults ){
        //此处为android 6.0 以上动态授权到回调，用户自行实现
       /* super.onRequestPermissionsResult(requestCode, persmissions, grantRsults);
        switch (requestCode){
            case Integer.parseInt(Manifest.permission.INTERNET):
    ...
    private void start() {
        ...
        params.put(SpeechConstant.VAD_ENDPOINT_TIMEOUT, 2000);
           // 不开启长语音。开启VAD尾点检测，即静音判断的毫秒数。建议设置800ms-3000ms
